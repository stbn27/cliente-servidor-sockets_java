...
/**
 * Fabrica de respuestas uniformes para todos los handlers RPC.
 */
public final class RespuestaRpcUtil {
    ...
    private static Hashtable crearRespuesta(Boolean exito, String codigo, String mensaje,
        ...
        respuesta.put("datos", datos == null ? new Hashtable() : datos);
        return respuesta;
    }
}
