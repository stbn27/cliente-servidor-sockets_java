...
/**
 * Entidad de inventario clinico en la replica.
 */
public record MedicamentoInventario(String clave, String nombre, int existencias, int minimoRecomendado,
                                    String ubicacion, String proveedor) {
